<template>
  <div class="TopLineBlock">
    ...
    <div class="MainBlock" v-if="curPage == 'WorkOrder' || curPage == 'SalesReport' || curPage == 'MRPList' || curPage == 'AddMRP' || curPage == 'MRPDetail' || curPage == 'HBDetail' || curPage == 'MaintenanceIndex' || curPage == 'MaintenanceList' || curPage == 'MaintenanceAdd' || curPage == 'MaintenanceDetail'"><span>{{curModuleInfo.department + '\xa0\xa0\xa0\xa0\xa0\xa0\xa0' + '汇报人: ' + userInfo.fname + '\xa0\xa0\xa0\xa0\xa0\xa0\xa0工种: ' + userInfo.gongxu}}</span></div>
